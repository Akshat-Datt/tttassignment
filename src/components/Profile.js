...
function Profile() {
  return (
    <div>
        <img src={require('../images/Anuj.png')} alt='profile' className={style.profile}/>
        <img src={require('../images/Cover.jpg')} alt='cover' className={style.cover}/>
        ...
        <a href='https://www.instagram.com/anujgosalia/?utm_source=ig_web_button_share_sheet&igshid=OGQ5ZDc2ODk2ZA==' target='_blank' rel="noreferrer" className={style.link}>http://www.instagram.com/anujgosalia</a>
